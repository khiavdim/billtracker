...
values
    ('at&t', 250, '2019-08-20', 1, 2), --1
    ('Verizon', 130, '2019-07-20', 3, 2), --2
    ('Best Buy', 50, '2019-08-20', 1, 7), --3
    ('Bank of America', 1000, '2019-09-10', 1, 1), --4
    ('Chase', 40, '2019-09-01', 2, 7),--5
    ('PG&E', 160, '2019-08-01', 4, 2), --6
    ('Walmart', 60, '2019-08-02', 3, 3), --7
    ('Wells Fargo', 250, '2019-08-02', 1, 5), --8
    ('Southwest', 123, '2019-08-10', 2, 6), --9
    ('Target', 50, '2019-08-10', 4, 4); --10
select *
from bills;

-- Enter bills/users
insert into users_bills (users_bills_user_id, users_bills_bill_id)
values (1 ,2), (1, 7), (1, 5), ()
